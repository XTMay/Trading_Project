...
Sub Macro30()
'
' mikeon _ 2018/4/6 _____的巨集

'
'
' mikeon _ 2018/4/8 _____的巨集
' __效
...
dt: f = 10: Do Until Left(Cells(15, f), 1) <> "_" '(__R表
f = f + 10
Loop
[d1] = f - 10
...
f = 10: Do Until Left(Cells(15, f), 1) <> "_" ' (__[表
f = f + 10
Loop

If Cells(16, f - 1) <> "" Then

Cells(1, f) = "_____X"k格X"
Cells(15, f) = "___X"GX"
Cells(2, f + 1) = "__""
Cells(1, f + 2) = "__""
Cells(1, f + 3) = "__""
...
Cells(14, f + 4) = "__""
Cells(14, f + 5) = "__""
Cells(14, f + 6) = "__": Cells(15, f + 6) = "__"顐"
Cells(14, f + 7) = "__"v"
Cells(14, f + 8) = "__+__"{金"
Cells(14, f + 9) = "__""
...
Next b
If b > 11 Then b = 11
Cells(b + 2, a) = "_________________(________)_________"稅頁除息表總計)才是正確的現金餘額"
Cells(b + 2, a).Select
    With Selection
...
For k = 1 To [d1] / 10
 ...
 url = "https://finance.yahoo.com/quote/" & Cells(2, 10 * k + 4) & [i15] & "=x?ltr=1" '__Alex_x吳
...
HL: Range(Columns(drr), Columns(dbk)).Clear
 ...
 Cells(i, f + 1) = Date
 If Cells(i, f + 7) = "" Then
 Cells(i, f + 7) = Cells(5, dbk + f / 10)  '__率
 ...
 Cells(18, f + 1) = "__________ 0"B不得為 0"
...
Cells(k + 1, drr + 1) = Cells(k + 15, f + 1) '__期
If Cells(k + 6, dbk + f / 10) = "" Then Cells(k + 6, dbk + f / 10) = Cells(k + 15, f + 7)
Cells(k + 1, drr + 2) = Cells(k + 15, f + 4) * Cells(k + 15, f + 7) / Cells(k + 6, dbk + f / 10)   '__票
Cells(k + 15, f + 4) = Cells(k + 15, f + 4) * Cells(k + 15, f + 7) / Cells(k + 6, dbk + f / 10)
Cells(k + 1, drr + 3) = Cells(k + 15, f + 5) * Cells(k + 15, f + 7) / Cells(k + 6, dbk + f / 10)  '__金
Cells(k + 15, f + 5) = Cells(k + 15, f + 5) * Cells(k + 15, f + 7) / Cells(k + 6, dbk + f / 10)
Cells(k + 1, drr + 4) = Cells(k + 15, f + 9) '__金
Cells(k + 15, f + 9) = Cells(k + 15, f + 9)
If k > 1 Then  '__/____金增額
...
End If
Cells(k + 1, drr + 8) = Cells(k + 1, drr + 5) - Cells(k + 1, drr + 6) '____增額
...
Cells(k + 1, drr + 8) = ""
Cells(k + 15, f + 3) = Cells(k + 15, f + 4) + Cells(k + 15, f + 5) - Cells(k + 15, f + 9) '___穨Q
Cells(4, dbk + f / 10) = Cells(k + 15, f + 3)
Cells(k + 15, f + 6) = Cells(k + 15, f + 4) / (Cells(k + 15, f + 4) + Cells(k + 15, f + 5)) '____比例
...
If q = 1 Then '__刪
i = 16
Do Until Cells(i, f + 3) = "" '_______ iQ刪處 i
i = i + 1
Loop
...
Columns("drr:dbk").Clear
 ...
 For j = 1 To [d1] / 10
 Cells(i, 5) = Cells(i, 5) + Cells(1, dbk + j) '__票
 Cells(i, 6) = Cells(i, 6) + Cells(2, dbk + j) '__金
 Cells(i, 9) = Cells(i, 9) + Cells(3, dbk + j) '__金
 Next j
...
If Cells(k + 15, f + 1) = "" Then Exit For
Cells(k + 1, drr + 1) = Cells(k + 15, f + 1) '__期
Cells(k + 1, drr + 2) = Cells(k + 15, f + 4) '__票
Cells(k + 1, drr + 3) = Cells(k + 15, f + 5) '__金
Cells(k + 1, drr + 4) = Cells(k + 15, f + 8) '__金
...
Cells(k + 1, drr + 7) = Cells(k + 1, drr + 8)
Cells(k + 1, drr + 8) = ""
Cells(k + 15, f + 3) = Cells(k + 15, f + 4) + Cells(k + 15, f + 5) - Cells(k + 15, f + 8) '___穨Q
Cells(k + 15, f + 6) = Cells(k + 15, f + 4) / (Cells(k + 15, f + 4) + Cells(k + 15, f + 5)) '____比例
...
Range("H10").Select
    ActiveCell.FormulaR1C1 = _
        "=IF(RC[-2]<0,""_____"",IF(RC[-1]>168,""_____"","""")&IF(AND(RC[-1]<=168,RC[-1]>100),""__"","""")&IF(AND(RC[-1]<=100,RC[-1]>21),""____"","""")&IF(RC[-1]<=21,""_____ !"",""""))"B美巴菲特 !"",""""))"


Cells(i + 1, f + 1) = "_____ 50 ___ 20% = 1.2^50 = 9,100"= 9,100"
Cells(i + 2, f + 1) = "_ " & Format(Cells(i + 1, f + 5), "##,##0.0") & " ___ " & Format(Cells(i - 1, f + 2), "##,##0%") & " ______ " & Format([g10], "##,##0") & " (____)_" & [h10]V好)，" & [h10]

Cells(i + 3, f + 1) = Format(Cells(i + 1, f + 5), "##,##0.0") & " ____A = 1.2^(50-" & Format(Cells(i + 1, f + 5), "##,##0.0") & ")_A^0.5 = " & Format([d5], "##,##0")##0")
Cells(i + 4, f + 1) = Format(Cells(i - 1, f + 2), "##,##0%") & " ___B (1+" & Format(Cells(i - 1, f + 2), "##,##0%") & ")^B = 9,100_B = " & Format([d6], "##,##0") & "_" "年"
Cells(i + 5, f + 1) = "______ " & Format([g10], "##,##0") & " = 100x(A^0.5xB)/3,701"3,701"
Cells(i + 6, f + 1) = "    __ 3,701 = (1.2^(50-8))^0.5xlog(9100,1+12%)_8___12%"均12%"
Else
...
[a1] = "1. ___________x_16_______"將16列底下範例刪除"
[a2] = "2. ___________ [__]"A再按 [更新]"
[a3] = "3. ____ " & [i15] & " ___ i15_________A70"代碼參閱美股A70"
[a4] = "4. XIRR _________________ 1 _ (1+XIRR)^(__/365)-1"+XIRR)^(天數/365)-1"
[a5] = "5. __ [__] [__] [__] [__] [__] _______ [__] __"更改，再按 [更新] 即可"
[a6] = "6. K _________________"加一張，張數無限"
[a7] = "7. [__]_________________"才需增減，平時不變"
[a8] = "    [__]_[__]_______"b上顯示填入"
[a10] = "________ B"嶉導 B"
...
Cells(1, drr + 3) = "__""
Cells(1, drr + 4) = "__""
Cells(1, drr + 5) = "____"W額"
Cells(1, drr + 6) = "____"W額"
Cells(1, drr + 7) = "____ = ____ - ____" - 本金增額"
...
USDD:
i = 3: Do Until Cells(i, f + 2) = "" And Cells(i, f + 4) = "" And i < 13   '_
Cells(i, f + 2).FormulaR1C1 = "=RC[2]-RC[1]"
i = i + 1
Loop
End If
