...
'__¥«
Application.StatusBar = "________"«¸ê®Æ¤¤"
Application.ScreenUpdating = True
Application.ScreenUpdating = False
...
'____«ü¼Æ
 ...
 TSEIndex = ""
 For i = 1 To 1000
      If Range("HA" & i) = "_________" Thenü¼Æ" Then
          TSEIndex = Range("HB" & i)
...
[i2] = "____ (__ " & Format(TSEIndex, "#,##0") & Space(2) & (Left([f9], 3) + 1911) & "_" & Mid([f9], 5, 2) & "_" & Mid([f9], 8, 2) & "_)") & "¤é)"
[i3] = "": [k3] = ""
Call OTCC
...
Application.StatusBar = "________"d¸ê®Æ¤¤"
    Application.ScreenUpdating = True
    Application.ScreenUpdating = False
      '____­ÓªÑ
      Range("ba:bf").Clear
      ...
      Dim url As String
       ...
       [f19] = Mid([ba1], InStr(1, [ba1], "____") + 5, 9) ' __' ¤é´Á
      ...
      '____--¼Æ--
       ...
       [n2] = "____ (__ " & Format([a19], "#,##0") & Space(2) & (Left([f19], 3) + 1911) & "_" & Mid([f19], 5, 2) & "_" & Right([f19], 2) & "_)") & "¤é)"
       [n3] = "": [p3] = ""
Exit Sub
'---------------------------------------------------------------------------
Sub_ExtractData:
...
'__+__¤é´Á
'Application.StatusBar = "_SNP500___"Æ¤¤"
...
Application.StatusBar = "______"ê®Æ¤¤"
Application.ScreenUpdating = True
Application.ScreenUpdating = False
 
'__225 ___________Ñ®}¼sºÖ®á¼¶¼g

Dim myIE As InternetExplorer
Dim myIEdoc As HTMLDocument         '____ª«¥ó
...
Set myIE = New InternetExplorer '______InternetExplorer__orerª«¥ó
...
With myIE
    ...
    t1 = Timer
    Do Until Timer > t1 + 5 '__5___________H§ï¦¨µ¥«Ý¤L¬í
        DoEvents
    Loop
    '______Alex___lex®á¼¶¼g
...
Application.StatusBar = "___225___"ü¼Æ¤¤"
Application.ScreenUpdating = True
Application.ScreenUpdating = False
url = "http://www.stockq.org/welcome.php"
Call ConnectMarketWatch(url, [ba1], 5)
...
'__+__¤é´Á
Application.StatusBar = "___50___"ü¼Æ¤¤"
Application.ScreenUpdating = True
Application.ScreenUpdating = False
url = "http://www.stockq.org/welcome.php"
Call ConnectMarketWatch(url, [ba1], 5)
...
[ah3] = "__": [ai3] = "__": [aj3] = "___"¥»¯q¤ñ"
Columns("ba:cz").Clear

'__+__¤é´Á
Application.StatusBar = "______"ü¼Æ¤¤"
Application.ScreenUpdating = True
Application.ScreenUpdating = False
url = "http://www.stockq.org/welcome.php"
Call ConnectMarketWatch(url, [ba1], 5)
